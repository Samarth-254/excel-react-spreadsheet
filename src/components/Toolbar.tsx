  ...
  const handleButtonClick = (action: string) => {
    ...
    switch (action) {
      ...
      case 'Filter':
        ...
        break;
      case 'Sort':
        // Sort functionality disabled - button remains visible but non-functional
        console.log('Sort functionality has been disabled');
        break;
    }
  };
  ...
  return (
    <div className="bg-white border-b border-gray-200">
      <div className="px-4 py-3">
        ...
        {/* Left side - Tool bar and Hide fields */}
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="flex items-center space-x-1 px-1 py-1 rounded hover:bg-gray-100"
          >
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="px-3 py-1.5 text-sm text-gray-700 hover:text-gray-900 border border-gray-300 rounded hover:bg-gray-50 flex items-center space-x-1"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
          ...
          <button
            ...
            className="px-3 py-1.5 text-sm text-white rounded flex items-center space-x-1"
            style={{ backgroundColor: '#4B6A4F',borderRadius:'6px',padding:'8px 24px' }}
            onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#1a2f1a'}
            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#4B6A4F'}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
